...
经确认，本仓库内容已被第三方用于付费倒卖（相关情况见：https://github.com/plsy1/iptv/issues/15 ），该行为与本项目宗旨严重不符，亦可能引发合规与法律风险。

~~鉴于上述滥用行为，本仓库不再提供单播地址，仅维护组播地址。~~
...
下线频道: 宁夏卫视, CCTV3, CCTV5, CCTV6, CCTV8
